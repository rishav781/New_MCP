...
async def test_release_device():
    ...
    try:
        ...
        # Try releasing again to check error handling
        try:
            await api.release_device(rid)
        except Exception as e:
            assert "already released" in str(e) or True  # Accept any error for already released
    finally:
        await api.close()
